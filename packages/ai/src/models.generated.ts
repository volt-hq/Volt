...
export const MODELS = {
	"amazon-bedrock": {
		...
		"anthropic.claude-fable-5": {
			...
			input: ["text", "image"],
			promptCache: {"modes":["explicit"],"retention":{"short":{"ttlSeconds":300},"long":{"ttlSeconds":3600}},"refreshesOnHit":true},
			cost: {
				input: 10,
				output: 50,
				cacheRead: 1,
		...
		"anthropic.claude-opus-4-1-20250805-v1:0": {
			...
			reasoning: true,
			input: ["text", "image"],
			promptCache: {"modes":["explicit"],"retention":{"short":{"ttlSeconds":300}},"refreshesOnHit":true},
			cost: {
				input: 15,
				output: 75,
				cacheRead: 1.5,
	...
	"azure-openai-responses": {
		...
		"gpt-4.1": {
			...
			reasoning: false,
			input: ["text", "image"],
			promptCache: {"modes":["implicit"],"retention":{"short":{},"long":{"ttlSeconds":86400}},"refreshesOnHit":true},
			cost: {
				input: 2,
				output: 8,
				cacheRead: 0.5,
		...
		"gpt-5.6": {
			...
			input: ["text", "image"],
			promptCache: {"modes":["implicit","explicit"],"retention":{"short":{"ttlSeconds":1800}},"refreshesOnHit":true},
			cost: {
				input: 4,
				output: 20,
				cacheRead: 0.4,
	...
	"fireworks": {
		"accounts/fireworks/models/deepseek-v4-flash-0731": {
			...
			compat: {"sendSessionAffinityHeaders":true,"supportsEagerToolInputStreaming":false,"supportsCacheControlOnTools":false},
			reasoning: true,
			input: ["text"],
			promptCache: {"modes":["implicit"],"retention":{"short":{}}},
			cost: {
	...
	"nvidia": {
		"deepseek-ai/deepseek-v4-flash-0731": {
			...
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","supportsStrictMode":false,"requiresReasoningContentOnAssistantMessages":true,"thinkingFormat":"deepseek"},
			reasoning: true,
			thinkingLevelMap: {"minimal":null,"low":null,"medium":null,"high":"high","xhigh":"max"},
			input: ["text"],
			cost: {
	...
	"together": {
		...
		"MiniMaxAI/MiniMax-M3": {
			...
			provider: "together",
			baseUrl: "https://api.together.ai/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"together"},
			reasoning: true,
			thinkingLevelMap: {"minimal":null,"low":null,"medium":null},
			input: ["text", "image"],
			cost: {
		...
		"deepseek-ai/DeepSeek-V4-Pro": {
			...
			provider: "together",
			baseUrl: "https://api.together.ai/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"together"},
			reasoning: true,
		...
		"openai/gpt-oss-120b": {
			...
			provider: "together",
			baseUrl: "https://api.together.ai/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":true,"maxTokensField":"max_tokens","supportsStrictMode":false,"thinkingFormat":"openai"},
			reasoning: true,
