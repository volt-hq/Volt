 ...
 * working indicator shown while volt is streaming a response.
 *
 * Usage:
 *   volt --extension examples/extensions/working-indicator.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@earendil-works/volt-coding-agent";
...
export default function (volt: ExtensionAPI) {
	...
	volt.registerCommand("working-indicator", {
