...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} remote host [options]     Host Volt RPC over Iroh using the temporary sidecar adapter
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as VOLT_OFFLINE=1)
