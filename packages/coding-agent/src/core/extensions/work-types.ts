...
export type ExtensionWorkService = "readText" | "findPaths" | "searchText";
...
/** Host ceilings; values may only tighten the defaults. All values are finite nonnegative integers. */
