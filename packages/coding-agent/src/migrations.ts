...
const MIGRATION_GUIDE_PATH = "packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_PATH = "packages/coding-agent/docs/extensions.md";
 ...
 * Note: tools/ may contain fd/rg binaries extracted by volt, so only warn if it has other files.
 */
...
export async function showDeprecationWarnings(warnings: string[]): Promise<void> {
	...
	console.log(chalk.yellow(`Migration guide: ${MIGRATION_GUIDE_PATH}`));
	console.log(chalk.yellow(`Documentation: ${EXTENSIONS_DOC_PATH}`));
