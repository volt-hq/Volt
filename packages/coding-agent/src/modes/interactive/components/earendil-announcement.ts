...
export class EarendilAnnouncementComponent extends Container {
	constructor() {
		...
		this.addChild(new Text(theme.bold(theme.fg("accent", "volt has joined Earendil")), 1, 0));
		this.addChild(new Spacer(1));
		this.addChild(new Text(theme.fg("muted", "Public announcement links are not configured in this fork."), 1, 0));
		this.addChild(new Spacer(1));
