...
const agentDirEnvName = "VOLT_CODING_AGENT_DIR";
const startupBenchmarkEnvName = "VOLT_STARTUP_BENCHMARK";
...
async function runTuiBenchmarkRun({ runtime, runIndex, measuredIndex, options, profileDir }) {
	...
	const tempRoot = options.isolatedAgentDir ? mkdtempSync(join(tmpdir(), "volt-startup-benchmark-")) : undefined;
